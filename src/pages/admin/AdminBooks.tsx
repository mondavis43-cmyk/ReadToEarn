...
async function handleSaveEdit() {
  ...
  // Calculate which questions to delete BEFORE inserting new ones
  // so newly inserted questions are never caught in the delete sweep
  ...
  // Now delete only the questions that were explicitly removed
