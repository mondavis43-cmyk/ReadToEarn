          ...
          {selectedBundle.books > 1 && (
            <div className="bg-[#1a1a1a] border border-gray-800 rounded-lg p-4 mb-6">
              <p className="text-gray-300 text-sm">
                You have <span className="text-white font-medium">{selectedBundle.books - 1} remaining slot{selectedBundle.books - 1 !== 1 ? 's' : ''}</span> in your bundle. Submit another book anytime using the same email.
              </p>
            </div>
          )}
  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f]">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        {/* Genres */}
        <div className="mb-10">
          <h2 className="font-serif text-2xl text-white mb-2">Genre <span className="text-gray-500 font-normal text-base">(optional)</span></h2>
        ...
        {/* Tropes */}
        <div className="mb-10">
          <h2 className="font-serif text-2xl text-white mb-2">Tropes <span className="text-gray-500 font-normal text-base">(optional)</span></h2>
        ...
        >
          {loading ? 'Redirecting to payment...' : `Pay $${selectedBundle.total.toFixed(2)} & Submit`}
        </button>
