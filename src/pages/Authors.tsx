      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="bg-[#1a1a1a] rounded-lg p-8 border border-gray-800 mb-16">
          ...
          <p className="text-gray-300 text-sm">
            One book listing fee cost $7 USD. We offer bundles with discounts that get higher the more listings you purchase. If you do not use all the listings at once, you keep those credits forever. They never expire.
          </p>
        </div>
