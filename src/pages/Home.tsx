...
<button onClick={toggleTheme} className="text-[#F5F0E8]/60 hover:text-[#F5F0E8] transition" aria-label="Toggle dark mode" >
...
<button onClick={handleLogout} className="text-[#F5F0E8]/60 hover:text-[#F5F0E8]/80 transition" >
Logout
</button>
</div>
</div>
