    ...
    return (
      <div className="min-h-screen bg-gray-950 text-white px-4 py-10 max-w-3xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">
          ...
          them write authentically. Earn $10.00 per panel.
        </p>

        {success && (
          <div className="bg-green-900/40 border border-green-500 text-green-300 rounded-lg p-4 mb-6">
            Feedback submitted! $10.00 has been added to your balance.
          </div>
        )}
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="text-right shrink-0">
                      <p className="text-yellow-400 font-bold text-lg">$10.00</p>
